...
RNA sequencing data for macrophages and monocytes. The research 
question addressed in this project is to understand the PMA-induced 
differentiation of monocytes to macrophages. The transcriptomic and 
proteomic acquisitions are conducted on two separate subset of similar 
cells (same experimental design). The identity of the cells are known only 
